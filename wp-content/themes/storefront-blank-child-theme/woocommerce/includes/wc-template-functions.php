...
function wc_empty_cart_message() {
	echo '<p class="cart-empty">' . apply_filters( 'wc_empty_cart_message', __( 'oh no! there appears to be nothing in here... yet! head back to the shop to see if there are some goodies you might like to gather. <br>🌻🌻🌻', 'woocommerce' ) ) . '</p>';
}
