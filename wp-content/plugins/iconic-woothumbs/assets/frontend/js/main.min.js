(function($, document) {
	...
	var iconic_image_height = $('.iconic-woothumbs-all-images-wrap').css('height');
	var iconic_thumnails_height = $('.iconic-woothumbs-thumbnails-wrap').css('height');
	
	if (parseInt(iconic_image_height)>0){
		$('.iconic-woothumbs-all-images-wrap').css('min-height',iconic_image_height+iconic_thumnails_height);
		// $('.iconic-woothumbs-all-images-wrap').css('max-height',iconic_image_height);
	}
}(jQuery, document));
/*!
